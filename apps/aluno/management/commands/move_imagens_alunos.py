...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # Carrega a fixture
        os.system('python manage.py loaddata aluno.json')

        # Move os arquivos de imagem
        image_static_dir = os.path.join(settings.BASE_DIR, 'core/static/img/alunos')
        image_dir = os.path.join(settings.MEDIA_ROOT, 'core/static/img/alunos')
