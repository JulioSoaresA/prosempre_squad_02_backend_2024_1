...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # Carrega a fixture
        os.system('python manage.py loaddata curso.json')

        # Move os arquivos de imagem
        image_static_dir = os.path.join(settings.BASE_DIR, 'core/static/img/cursos')
        image_dir = os.path.join(settings.MEDIA_ROOT, 'core/static/img/cursos')
